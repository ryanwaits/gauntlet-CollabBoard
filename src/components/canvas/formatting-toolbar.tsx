  ...
  return (
    ...
    >
      <button
        ...
        onClick={() => onFormatChange({ font_weight: isBold ? "normal" : "bold" })}
      >
        <span className="font-bold">B</span>
      </button>
      <button
        className={btnClass(isItalic)}
        onClick={() => onFormatChange({ font_style: isItalic ? "normal" : "italic" })}
      >
        <span className="italic">I</span>
      </button>
      <button
        className={btnClass(isUnderline)}
        onClick={() => onFormatChange({ text_decoration: isUnderline ? "none" : "underline" })}
      >
      ...
      <button
        ...
        onClick={() => onFormatChange({ text_align: "left" })}
      >
        <AlignLeft className="h-3.5 w-3.5" />
      </button>
      <button
        className={btnClass(textAlign === "center")}
        onClick={() => onFormatChange({ text_align: "center" })}
      >
        <AlignCenter className="h-3.5 w-3.5" />
      </button>
      <button
        className={btnClass(textAlign === "right")}
        onClick={() => onFormatChange({ text_align: "right" })}
      >
